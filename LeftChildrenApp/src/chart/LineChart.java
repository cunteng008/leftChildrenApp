...
public class LineChart {
	 ...
	 * @param xyDataset 数据集
	 */
	public static JFreeChart createLineAndShapeChart(String chartTitle, String xTitle, String yTitle, CategoryDataset  xyDataset){
		//构建一个chart
...
//		try {
//			FileOutputStream fos = new FileOutputStream("d:/test/abc.png");
