...
public class Piechart extends JFrame{
	...
	public static JFreeChart createPieChart3D(String chartTitle,PieDataset dataset, String[] pieKeys) {
		...
		//关闭抗锯齿，是字体清晰
		chart.getRenderingHints().put(RenderingHints.KEY_TEXT_ANTIALIASING,RenderingHints.
	...
	// 饼状图 数据集
	public static PieDataset getDataPie(double[] data,	String[] datadescription) {
...
//			{ "失败率", "成功率" ,"满意"};
//
//			JFreeChart chart =	createPieChart3D("饼状图",getDataPieSetByUtil(data, keys), keys);
//
//		
...
//					JPanel chartPanle = new ChartPanel(chart); 
//					frame.add(chartPanle);
//					frame.pack();
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
